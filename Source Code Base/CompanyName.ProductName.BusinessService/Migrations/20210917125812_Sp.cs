...
@UpdatedByUserId uniqueidentifier
           ...
           BEGIN
             SET NOCOUNT ON;
            Insert into Applicant([Name],[Email],[MobileNumber],[DateOfBirth],[Gender],[Password],[ConfirmPassword],
...
[Skills],[Experience],[RoleId],[CreatedAt],[Id],[Status],[CreatedByUserId],[UpdatedByUserId])
